...
__Open Knowledge International (⬄ OKI)__ organizasyonu da kendince bağımsız bir tanım yapmıştır. Bu tanımında farklı sürümleri mevcuttur: http://opendefinition.org/od/2.1/en/
