...
!!! note "My comments for the book"
    ...
    - <a target="_blank" rel="noopener noreferrer" href="https://github.com/yusuf-daglioglu/tutorials/blob/master/tutorials/db_cassandra.md">https://github.com/yusuf-daglioglu/tutorials/blob/master/tutorials/db_cassandra.md</a>
...
!!! note "My comments for the book"
    ...
    - <a target="_blank" rel="noopener noreferrer" href="https://github.com/yusuf-daglioglu/tutorials/blob/master/tutorials/unix_like.md">https://github.com/yusuf-daglioglu/tutorials/blob/master/tutorials/unix_like.md</a>

    - <a target="_blank" rel="noopener noreferrer" href="https://github.com/yusuf-daglioglu/tutorials/blob/master/tutorials/unix_like_shell_syntax.md">https://github.com/yusuf-daglioglu/tutorials/blob/master/tutorials/unix_like_shell_syntax.md</a>

    - <a target="_blank" rel="noopener noreferrer" href="https://github.com/yusuf-daglioglu/tutorials/blob/master/tutorials/unix_like_commands.md">https://github.com/yusuf-daglioglu/tutorials/blob/master/tutorials/unix_like_commands.md</a>
...
!!! success "Masumiyet Müzesi"

    Authors: Orhan Pamuk

    About the author:<br>

    - life:1952 - present<br>
    - Nobel Edebiyat Ödüllü, romancı.<br>
...
!!! success "Herşey seninle ilgili değil"

    Authors: Niels Overgaard
...
!!! note "My comments for the book"
    ...
    şiir kitabı. İngilizce orjinal dilinde okudum.
...
!!! note "My comments for the book"
    ...
    şiir kitabı. Yazarın geçmiş birçok eserlerini birleştiren bir kitap. Ortalama 500 sayfa. İngilizce orjinal dilinde okudum.
