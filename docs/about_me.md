...
- 🎶 music & lyrics archivist, fan of jazz & blues & classical music
...
- :material-linkedin: from social medias (Linkedin, Instagram, Twitter)
...
- <span style="color:cyan">:simple-simplex:</span> SimpleX messenger
    ...
    <span style="color:green">__:octicons-shield-16: Send me anonymous messages (hide your phone number to me)__</span>
...
- <span style="color:blue">:simple-signal:</span> Signal messenger
    ...
    <span style="color:green">__:octicons-shield-16:__ If you send me message via username, it will be anonymous only if we don't have each other's phone number.</span>
