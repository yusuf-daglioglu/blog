...
- <span style="color:blue">:material-linkedin:</span> from social medias (Linkedin, Instagram, Twitter)
    ...
    :fontawesome-solid-user: Links are below of this page.
...
- <span style="color:cyan">:simple-simplex:</span> SimpleX messenger
    ...
    :fontawesome-solid-user: <a target="_blank" rel="noopener noreferrer" href="https://smp16.simplex.im/a#kUMxSl5H6daTykFNRC9CjDCSdM5vMID14_59vnTmaOM"> Scan this QR </a> to access my contact
