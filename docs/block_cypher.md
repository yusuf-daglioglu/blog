...
`Blok şifreleme` kullanan birçok algoritma vardır. Fakat her `blok şifreleme`nin de birçok türevi/uzantısı vardır. Bunlar "__çalışma kipi (⟷ mode of operation)__" olarak ta adlandırılırlar. örnek çalışma kipleri:
...
<https://github.com/yusuf-daglioglu/tutorials/tree/master/tutorials> `security` prefix'li tüm dosyalar.
